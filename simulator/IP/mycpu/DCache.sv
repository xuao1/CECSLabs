...
/* -------------- 8 read data control: choose data from mem or return buffer -------------- */
    ...
    assign rdata_ret    = uncached == 1 ? {rdata_ret[BIT_NUM-1:BIT_NUM-96], ret_buf[BIT_NUM-1:BIT_NUM-32]} : ret_buf >> {addr_pipe[BYTE_OFFSET_WIDTH-1:2], 5'b0};
